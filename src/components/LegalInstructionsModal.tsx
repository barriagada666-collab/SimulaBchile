        ...
        <div className="p-6 overflow-y-auto space-y-6 text-sm text-slate-700 leading-relaxed">
          <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-xl">
            <h3 className="font-bold text-slate-900 mb-2 flex items-center gap-2">
              <BookOpen className="w-4 h-4 text-blue-600" /> Fundamento Legal
            </h3>
            <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/50">
              ...
              <p className="text-slate-600 text-xs">
                El examen oficial incorpora <strong className="text-slate-900">35 preguntas</strong>, de las cuales <strong className="text-slate-900">3 tienen doble puntuación (2 puntos)</strong> correspondientes a temas críticos:
              </p>
            ...
            <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/50">
              ...
              <p className="text-slate-600 text-xs">
                El examen suma un total de <strong className="text-slate-900">38 puntos</strong>. Se exige obtener un mínimo de <strong className="text-emerald-700 bg-emerald-50 px-1 py-0.5 rounded font-bold">33 puntos</strong> para la aprobación (86,8%).
              </p>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/50 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-sm">Tiempo Límite</h4>
              <p className="text-xs text-slate-600 mt-0.5">
                El tiempo máximo oficial para rendir el examen teórico es de <strong className="text-slate-900">45 minutos continuos</strong>. Al agotarse el cronómetro, el examen se envía automáticamente.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/50 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-sm">Algoritmo Anti-Memorización Mecánica</h4>
              <p className="text-xs text-slate-600 mt-0.5">
          ...
          <div className="border-t border-slate-200 pt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-600">
              <div className="p-2 rounded bg-slate-100/70">
                <span className="font-semibold text-slate-800">Ley N° 18.290:</span> Ley de Tránsito General de Chile.
              </div>
              <div className="p-2 rounded bg-slate-100/70">
                <span className="font-semibold text-slate-800">Ley Emilia (N° 20.770):</span> Sanciones con cárcel efectiva por ebriedad y fuga.
              </div>
              <div className="p-2 rounded bg-slate-100/70">
                <span className="font-semibold text-slate-800">Ley Tolerancia Cero (N° 20.580):</span> Baja umbrales de alcohol a 0,3 y 0,8 g/l.
              </div>
              <div className="p-2 rounded bg-slate-100/70">
                <span className="font-semibold text-slate-800">Ley de Convivencia Vial (N° 21.088):</span> 50 km/h en zonas urbanas.
              </div>
            </div>
          </div>
        </div>
