    ...
    <div className="w-full max-w-4xl mx-auto space-y-8 animate-fade-in pb-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 text-center">
          ...
          <span className="text-2xl font-black text-slate-900 dark:text-white">
            {totalScore} <span className="text-sm font-normal text-slate-400 dark:text-slate-500">/ 38</span>
          </span>
          <span className="block text-[11px] text-slate-500 dark:text-slate-400 mt-1">Mínimo: 33 pts</span>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 text-center">
          ...
          <span className="text-2xl font-black text-emerald-600 dark:text-emerald-400">
            {correctCount} <span className="text-sm font-normal text-slate-400 dark:text-slate-500">/ 35</span>
          </span>
          <span className="block text-[11px] text-slate-500 dark:text-slate-400 mt-1">Preguntas acertadas</span>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 text-center">
          ...
          <span className="text-2xl font-black text-rose-600 dark:text-rose-400">
            {35 - correctCount} <span className="text-sm font-normal text-slate-400 dark:text-slate-500">/ 35</span>
          </span>
          <span className="block text-[11px] text-slate-500 dark:text-slate-400 mt-1">Para reforzar</span>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 text-center">
          ...
          <span className="text-2xl font-black text-amber-600 dark:text-amber-400">
            {criticalCorrect} <span className="text-sm font-normal text-slate-400 dark:text-slate-500">/ 3</span>
          </span>
          <span className="block text-[11px] text-slate-500 dark:text-slate-400 mt-1">Doble puntaje</span>
        </div>
      </div>

      {/* ========================================================================= */}
      {/* GRÁFICO DE TENDENCIA DE RENDIMIENTO ENTRE ENSAYOS                         */}
      {/* ========================================================================= */}
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100 dark:border-slate-800">
          ...
          {/* Selector de Métrica */}
          <div className="flex flex-wrap items-center gap-1.5 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl self-start sm:self-auto">
            <button
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-slate-50/80 dark:bg-slate-950/70 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
          <div>
            <span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">
              Total Ensayos
            </span>
            <span className="text-lg font-black text-slate-900 dark:text-white">
              {chartData.length} <span className="text-xs font-normal text-slate-500 dark:text-slate-400">rendidos</span>
            </span>
          </div>
          ...
          <div>
            ...
            <span className="text-lg font-black text-blue-700 dark:text-blue-400">
              {aggregateStats.avgPoints} <span className="text-xs font-normal text-slate-500 dark:text-slate-400">/ 38 pts</span>
            </span>
          </div>
          ...
          <div>
            ...
            <span className="text-lg font-black text-emerald-700 dark:text-emerald-400">
              {aggregateStats.bestPoints} <span className="text-xs font-normal text-slate-500 dark:text-slate-400">pts</span>
            </span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-3 border-t border-slate-100 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400">
              ...
              <>
                {showConfirmClear ? (
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 transition-colors rounded-lg hover:bg-rose-50 dark:hover:bg-rose-950/40"
        ...
        <div className="p-3.5 rounded-xl bg-blue-50/70 dark:bg-blue-950/40 border border-blue-200/80 dark:border-blue-800/60 text-xs text-blue-950 dark:text-blue-200 flex items-start gap-2.5">
          <Target className="w-4 h-4 text-blue-600 dark:text-blue-400 shrink-0 mt-0.5" />
          <div>
            <span className="font-bold text-blue-950 dark:text-blue-100">Estrategia de Preparación CONASET:</span>{' '}
            ...
            <button
              ...
              className={`px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors ${
                selectedCategoryFilter === 'mistakes'
                  ? 'bg-rose-50 dark:bg-rose-950/70 text-rose-800 dark:text-rose-300 shadow-sm'
                  : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors ${
                selectedCategoryFilter === 'critical'
                  ? 'bg-amber-50 dark:bg-amber-950/70 text-amber-800 dark:text-amber-300 shadow-sm'
                  : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'
              }`}
            >
              Críticas (3)
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-4 flex items-start justify-between gap-4 text-left hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors"
                  >
                      ...
                      <div>
                        <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1">
                          ...
                          {q.isCritical && (
                            <>
                              <span>·</span>
                              <span className="text-amber-700 dark:text-amber-400 font-bold">Crítica</span>
                            </>
                          )}
                        </div>
                    ...
                    <div className="px-5 pb-5 pt-1 border-t border-slate-100 dark:border-slate-800 space-y-4">
                      ...
                      <div className="space-y-2">
                        {q.options.map((opt, oIdx) => {
                          ...
                          let optionBoxStyle = 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/90 text-slate-600 dark:text-slate-300';
                          if (wasChosen && isRight) {
                            optionBoxStyle = 'border-emerald-500 dark:border-emerald-600 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-950 dark:text-emerald-200 font-semibold';
                          } else if (wasChosen && !isRight) {
                            optionBoxStyle = 'border-rose-500 dark:border-rose-600 bg-rose-50 dark:bg-rose-950/40 text-rose-950 dark:text-rose-200 font-semibold';
                          } else if (!wasChosen && isRight) {
                            optionBoxStyle = 'border-emerald-400 dark:border-emerald-600 border-dashed bg-emerald-50/40 dark:bg-emerald-950/30 text-emerald-900 dark:text-emerald-200';
                          }
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1">
                                <span>{opt.text}</span>
                                {wasChosen && !isRight && (
                                  <span className="ml-2 text-rose-600 dark:text-rose-400 font-bold text-xs">
                                    (Tu respuesta incorrecta)
                                  </span>
                                )}
                                {wasChosen && isRight && (
                                  <span className="ml-2 text-emerald-600 dark:text-emerald-400 font-bold text-xs">
                      ...
                      {/* Explicación Legal */}
                      <div className="p-4 rounded-xl bg-blue-50/80 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 text-xs text-slate-800 dark:text-slate-200 leading-relaxed">
                        <div className="flex items-center gap-1.5 font-bold text-blue-950 dark:text-blue-300 mb-1">
                          <BookOpen className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400" />
                          <span>Fundamento CONASET</span>
                        </div>
                        <p>{q.explanation}</p>
                        {q.legalReference && (
                          <p className="mt-1.5 font-semibold text-blue-800 dark:text-blue-400">
